...
<div class="tribe-events-venue">
	<div class="cmsmasters_events_venue_header clearfix">
		...
		<div class="cmsmasters_events_venue_header_right clearfix">
			<div class="tribe-events-back">
				<a class="cmsmasters_theme_icon_date" href="<?php echo esc_url( tribe_get_events_link() ); ?>" rel="bookmark"><?php printf( esc_html__( 'Back to %s', 'language-school' ), tribe_get_event_label_plural() ); ?></a>
			</div>
		</div>
	</div>
	<div class="tribe-events-venue-meta vcard tribe-clearfix">
		...
		if (has_post_thumbnail() || (tribe_embed_google_map() && tribe_address_exists())) {
			echo '<div class="cmsmasters_events_venue_meta_inner">';
				if (has_post_thumbnail()) {
					echo '<div class="cmsmasters_events_venue_meta_img' . ((tribe_embed_google_map() && tribe_address_exists()) ? '' : ' cmsmasters_events_venue_meta_full_width') . '">' . 
						tribe_event_featured_image(null, 'cmsmasters-project-thumb') . 
					'</div>';
				}
				
				
				if (tribe_embed_google_map() && tribe_address_exists()) {
					echo '<div class="cmsmasters_events_venue_meta_map' . (!has_post_thumbnail() ? ' cmsmasters_events_venue_meta_full_width' : '') . '">' . 
