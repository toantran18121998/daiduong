...
if ( isset( $posts ) && $posts ) : ?>
	...
	<p class="tribe-events-widget-link">
		<a href="<?php echo esc_url( esc_url( $link_to_all ) ) ?>" rel="bookmark">
			<?php esc_html_e( 'View More&hellip;', 'language-school' ) ?>
		</a>
	</p>
...
?>
	<p><?php printf( esc_html__( 'There are no upcoming %s at this time.', 'language-school' ), strtolower( tribe_get_event_label_plural() ) ); ?></p>
<?php
endif;
