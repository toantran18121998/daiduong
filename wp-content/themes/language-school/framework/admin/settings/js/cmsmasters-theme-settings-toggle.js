...
(function ($) { 
	...
	if ($('input[name*="' + cmsmasters_settings.shortname + '_header_styles"]:checked').val() === 'c_nav') {
		...
		$('#' + cmsmasters_settings.shortname + '_header_button_check').parents('tr').hide();
		$('#' + cmsmasters_settings.shortname + '_header_button_text').parents('tr').hide();
		$('#' + cmsmasters_settings.shortname + '_header_button_link').parents('tr').hide();
		$('#' + cmsmasters_settings.shortname + '_header_donations_but').parents('tr').hide();
		$('#' + cmsmasters_settings.shortname + '_header_donations_but_text').parents('tr').hide();
		$('input[name*="' + cmsmasters_settings.shortname + '_header_add_cont"]').parents('tr').hide();
		$('#' + cmsmasters_settings.shortname + '_header_add_cont_cust_html').parents('tr').hide();
	...
	if ($('#' + cmsmasters_settings.shortname + '_header_button_check').is(':not(:checked)')) {
		$('#' + cmsmasters_settings.shortname + '_header_button_text').parents('tr').hide();
		$('#' + cmsmasters_settings.shortname + '_header_button_link').parents('tr').hide();
	}
	...
	$('input[name*="' + cmsmasters_settings.shortname + '_header_styles"]').on('change', function () { 
		if ($('input[name*="' + cmsmasters_settings.shortname + '_header_styles"]:checked').val() === 'default') {
			$('#' + cmsmasters_settings.shortname + '_header_button_check').parents('tr').show();
			$('#' + cmsmasters_settings.shortname + '_header_bot_height').parents('tr').hide();
			...
			if ($('#' + cmsmasters_settings.shortname + '_header_button_check').is(':checked')) {
				$('#' + cmsmasters_settings.shortname + '_header_button_text').parents('tr').show();
				$('#' + cmsmasters_settings.shortname + '_header_button_link').parents('tr').show();
			} else {
				$('#' + cmsmasters_settings.shortname + '_header_button_text').parents('tr').hide();
				$('#' + cmsmasters_settings.shortname + '_header_button_link').parents('tr').hide();
			}
	...
	$('#' + cmsmasters_settings.shortname + '_header_button_check').on('change', function () { 
		if ($('#' + cmsmasters_settings.shortname + '_header_button_check').is(':checked')) {
			$('#' + cmsmasters_settings.shortname + '_header_button_text').parents('tr').show();
			$('#' + cmsmasters_settings.shortname + '_header_button_link').parents('tr').show();
		} else {
