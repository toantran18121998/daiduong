...
function get_custom_profile_meta_fields() {
	...
	$cmsmasters_global_profile_post_title = (isset($cmsmasters_option['language-school' . '_profile_post_title']) && $cmsmasters_option['language-school' . '_profile_post_title'] !== '') ? (($cmsmasters_option['language-school' . '_profile_post_title'] == 1) ? 'true' : 'false') : 'true';

	$cmsmasters_global_profile_post_details_title = (isset($cmsmasters_option['language-school' . '_profile_post_details_title']) && $cmsmasters_option['language-school' . '_profile_post_details_title'] !== '') ? $cmsmasters_option['language-school' . '_profile_post_details_title'] : esc_html__('Profile details', 'language-school');

	$cmsmasters_global_profile_post_share_box = (isset($cmsmasters_option['language-school' . '_profile_post_share_box']) && $cmsmasters_option['language-school' . '_profile_post_share_box'] !== '') ? (($cmsmasters_option['language-school' . '_profile_post_share_box'] == 1) ? 'true' : 'false') : 'true';
	...
	$tabs_array['cmsmasters_profile'] = array( 
		'label' => esc_html__('Profile', 'language-school'), 
	...
	$custom_profile_meta_fields = array( 
		...
		array( 
			'label'	=> esc_html__('Profile Title', 'language-school'), 
		...
		array( 
			'label'	=> esc_html__('Subtitle', 'language-school'), 
			'desc'	=> '', 
		...
		array( 
			'label'	=> esc_html__('Profile Color', 'language-school'), 
			'desc'	=> '', 
		...
		array( 
			'label'	=> esc_html__('Profile Details Title', 'language-school'), 
			'desc'	=> '', 
		...
		array( 
			'label'	=> esc_html__('Social Icons', 'language-school'), 
			'desc'	=> esc_html__('Add social icons for this profile', 'language-school'), 
		...
		array( 
			'label'	=> esc_html__('Profile Info', 'language-school'), 
			'desc'	=> '', 
		...
		array( 
			'label'	=> esc_html__('Profile Features 1 Title', 'language-school'), 
			'desc'	=> '', 
		...
		array( 
			'label'	=> esc_html__('Profile Features 1', 'language-school'), 
			'desc'	=> '', 
		...
		array( 
			'label'	=> esc_html__('Profile Features 2 Title', 'language-school'), 
			'desc'	=> '', 
		...
		array( 
			'label'	=> esc_html__('Profile Features 2', 'language-school'), 
			'desc'	=> '', 
		...
		array( 
			'label'	=> esc_html__('Profile Features 3 Title', 'language-school'), 
			'desc'	=> '', 
		...
		array( 
			'label'	=> esc_html__('Profile Features 3', 'language-school'), 
			'desc'	=> '', 
