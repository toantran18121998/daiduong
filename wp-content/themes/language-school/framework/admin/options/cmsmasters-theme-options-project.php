...
function get_custom_project_meta_fields() {
	...
	$cmsmasters_global_portfolio_project_title = (isset($cmsmasters_option['language-school' . '_portfolio_project_title']) && $cmsmasters_option['language-school' . '_portfolio_project_title'] !== '') ? (($cmsmasters_option['language-school' . '_portfolio_project_title'] == 1) ? 'true' : 'false') : 'true';

	$cmsmasters_global_portfolio_project_details_title = (isset($cmsmasters_option['language-school' . '_portfolio_project_details_title']) && $cmsmasters_option['language-school' . '_portfolio_project_details_title'] !== '') ? $cmsmasters_option['language-school' . '_portfolio_project_details_title'] : esc_html__('Project details', 'language-school');

	$cmsmasters_global_portfolio_project_share_box = (isset($cmsmasters_option['language-school' . '_portfolio_project_share_box']) && $cmsmasters_option['language-school' . '_portfolio_project_share_box'] !== '') ? (($cmsmasters_option['language-school' . '_portfolio_project_share_box'] == 1) ? 'true' : 'false') : 'true';

	$cmsmasters_global_portfolio_project_author_box = (isset($cmsmasters_option['language-school' . '_portfolio_project_author_box']) && $cmsmasters_option['language-school' . '_portfolio_project_author_box'] !== '') ? (($cmsmasters_option['language-school' . '_portfolio_project_author_box'] == 1) ? 'true' : 'false') : 'true';

	$cmsmasters_global_portfolio_more_projects_box = (isset($cmsmasters_option['language-school' . '_portfolio_more_projects_box'])) ? $cmsmasters_option['language-school' . '_portfolio_more_projects_box'] : 'related';
	...
	$tabs_array['cmsmasters_project'] = array( 
		'label' => esc_html__('Project', 'language-school'), 
	...
	$custom_project_meta_fields = array( 
		...
		array( 
			'label'	=> esc_html__('Project Images', 'language-school'), 
			'desc'	=> '', 
		...
		array( 
			'label'	=> esc_html__('Number of Columns', 'language-school'), 
			'desc'	=> '', 
			...
			'options' => array( 
				'three' => array( 
					'label' => esc_html__('Three', 'language-school'), 
					'value'	=> 'three' 
				), 
				'two' => array( 
					'label' => esc_html__('Two', 'language-school'), 
					'value'	=> 'two' 
				), 
				'one' => array( 
					'label' => esc_html__('One', 'language-school'), 
					'value'	=> 'one' 
				) 
			) 
		),
		...
		array( 
			'label'	=> esc_html__('Project Title', 'language-school'), 
		...
		array( 
			'label'	=> esc_html__('Project Size', 'language-school'), 
			'desc'	=> esc_html__('Recomended Featured Image dimensions', 'language-school') . ' - ', 
		...
		array( 
			'label'	=> esc_html__('Project Details Title', 'language-school'), 
			'desc'	=> '', 
		...
		array( 
			'label'	=> esc_html__('Project Info', 'language-school'), 
			'desc'	=> '', 
		...
		array( 
			'label'	=> esc_html__("Project Link Text", 'language-school'), 
			'desc'	=> '', 
			'id'	=> $cmsmasters_option_name . 'link_text', 
			'type'	=> 'text', 
			'hide'	=> '', 
			'std'	=> esc_html__('View Project', 'language-school') 
		), 
		array( 
			'label'	=> esc_html__("Project Link URL", 'language-school'), 
			'desc'	=> '', 
		...
		array( 
			'label'	=> '', 
			'desc'	=> esc_html__('Redirect to project link URL instead of opening project page', 'language-school'), 
		...
		array( 
			'label'	=> esc_html__("Project Link Target", 'language-school'), 
			'desc'	=> esc_html__('Open link in a new tab', 'language-school'), 
		...
		array( 
			'label'	=> esc_html__('Project Features 1 Title', 'language-school'), 
			'desc'	=> '', 
		...
		array( 
			'label'	=> esc_html__('Project Features 1', 'language-school'), 
			'desc'	=> '', 
		...
		array( 
			'label'	=> esc_html__('Project Features 2 Title', 'language-school'), 
			'desc'	=> '', 
		...
		array( 
			'label'	=> esc_html__('Project Features 2', 'language-school'), 
			'desc'	=> '', 
		...
		array( 
			'label'	=> esc_html__('Project Features 3 Title', 'language-school'), 
			'desc'	=> '', 
		...
		array( 
			'label'	=> esc_html__('Project Features 3', 'language-school'), 
			'desc'	=> '', 
