...
use MailPoetVendor\Twig\Extension\InitRuntimeInterface;
...
class Environment
{
     ...
     */
    public function __construct(\MailPoetVendor\Twig\Loader\LoaderInterface $loader = null, $options = [])
    {
        if (null !== $loader) {
        ...
        $options = \array_merge(['debug' => \false, 'charset' => 'UTF-8', 'base_template_class' => '\\MailPoetVendor\\Twig\\Template', 'strict_variables' => \false, 'autoescape' => 'html', 'cache' => \false, 'auto_reload' => null, 'optimizations' => -1], $options);
        ...
        $this->addExtension(new \MailPoetVendor\Twig\Extension\CoreExtension());
        $this->addExtension(new \MailPoetVendor\Twig\Extension\EscaperExtension($options['autoescape']));
        $this->addExtension(new \MailPoetVendor\Twig\Extension\OptimizerExtension($options['optimizations']));
        $this->staging = new \MailPoetVendor\Twig\Extension\StagingExtension();
        // For BC
    ...
    public function setCache($cache)
    {
        if (\is_string($cache)) {
            ...
            $this->cache = new \MailPoetVendor\Twig\Cache\FilesystemCache($cache);
        } elseif (\false === $cache) {
            $this->originalCache = $cache;
            $this->cache = new \MailPoetVendor\Twig\Cache\NullCache();
        } elseif (null === $cache) {
            ...
            $this->cache = new \MailPoetVendor\Twig\Cache\NullCache();
        } elseif ($cache instanceof \MailPoetVendor\Twig\Cache\CacheInterface) {
    ...
    {
        if ($name instanceof \MailPoetVendor\Twig\TemplateWrapper) {
            return $name;
        }
        if ($name instanceof \MailPoetVendor\Twig\Template) {
            return new \MailPoetVendor\Twig\TemplateWrapper($this, $name);
        }
        return new \MailPoetVendor\Twig\TemplateWrapper($this, $this->loadTemplate($name));
    }
    /**
    ...
    public function loadClass($cls, $name, $index = null)
    {
        ...
        if (!\class_exists($cls, \false)) {
            ...
            if (!\class_exists($cls, \false)) {
                throw new \MailPoetVendor\Twig\Error\RuntimeError(\sprintf('Failed to load Twig template "%s", index "%s": cache might be corrupted.', $name, $index), -1, $source);
            }
        }
    ...
    public function createTemplate($template, $name = null)
    {
        ...
        $loader = new \MailPoetVendor\Twig\Loader\ChainLoader([new \MailPoetVendor\Twig\Loader\ArrayLoader([$name => $template]), $current = $this->getLoader()]);
        $this->setLoader($loader);
        try {
            $template = new \MailPoetVendor\Twig\TemplateWrapper($this, $this->loadTemplate($name));
        } catch (\Exception $e) {
    ...
    public function resolveTemplate($names)
    {
        ...
        throw new \MailPoetVendor\Twig\Error\LoaderError(\sprintf('Unable to find one of the following templates: "%s".', \implode('", "', $names)));
    }
    /**
    ...
    public function getLexer()
    {
        ...
        if (null === $this->lexer) {
            $this->lexer = new \MailPoetVendor\Twig\Lexer($this);
        }
        return $this->lexer;
    }
    public function setLexer(\MailPoetVendor\Twig_LexerInterface $lexer)
    {
        $this->lexer = $lexer;
    }
    /**
    ...
    {
        if (!$source instanceof \MailPoetVendor\Twig\Source) {
            ...
            $source = new \MailPoetVendor\Twig\Source($source, $name);
        }
        if (null === $this->lexer) {
            $this->lexer = new \MailPoetVendor\Twig\Lexer($this);
        }
    ...
    public function getParser()
    {
        @\trigger_error(\sprintf('The %s() method is deprecated since version 1.25 and will be removed in 2.0.', __FUNCTION__), \E_USER_DEPRECATED);
        if (null === $this->parser) {
            $this->parser = new \MailPoetVendor\Twig\Parser($this);
        }
        return $this->parser;
    }
    public function setParser(\MailPoetVendor\Twig_ParserInterface $parser)
    {
        $this->parser = $parser;
    }
    /**
    ...
    public function getCompiler()
    {
        ...
        if (null === $this->compiler) {
            $this->compiler = new \MailPoetVendor\Twig\Compiler($this);
        }
        return $this->compiler;
    }
    public function setCompiler(\MailPoetVendor\Twig_CompilerInterface $compiler)
    {
     ...
     */
    public function compile(\MailPoetVendor\Twig_NodeInterface $node)
    {
        if (null === $this->compiler) {
            $this->compiler = new \MailPoetVendor\Twig\Compiler($this);
        }
    ...
    public function compileSource($source, $name = null)
    {
        ...
        } catch (\MailPoetVendor\Twig\Error\Error $e) {
            $e->setSourceContext($source);
            throw $e;
        } catch (\Exception $e) {
            throw new \MailPoetVendor\Twig\Error\SyntaxError(\sprintf('An exception has been thrown during the compilation of a template ("%s").', $e->getMessage()), -1, $source, $e);
        }
    }
    public function setLoader(\MailPoetVendor\Twig\Loader\LoaderInterface $loader)
    {
        if (!$loader instanceof \MailPoetVendor\Twig\Loader\SourceContextLoaderInterface && 0 !== \strpos(\get_class($loader), 'Mock_')) {
    ...
    public function initRuntime()
    {
        ...
        foreach ($this->getExtensions() as $name => $extension) {
            if (!$extension instanceof \MailPoetVendor\Twig\Extension\InitRuntimeInterface) {
                $m = new \ReflectionMethod($extension, 'initRuntime');
                $parentClass = $m->getDeclaringClass()->getName();
                if ('MailPoetVendor\\Twig_Extension' !== $parentClass && 'MailPoetVendor\\Twig\\Extension\\AbstractExtension' !== $parentClass) {
     ...
     */
    public function addRuntimeLoader(\MailPoetVendor\Twig\RuntimeLoader\RuntimeLoaderInterface $loader)
    {
    ...
    public function getExtension($class)
    {
        ...
        if (!isset($this->extensionsByClass[$class])) {
            throw new \MailPoetVendor\Twig\Error\RuntimeError(\sprintf('The "%s" extension is not enabled.', $class));
        }
    ...
    public function getRuntime($class)
    {
        ...
        throw new \MailPoetVendor\Twig\Error\RuntimeError(\sprintf('Unable to load the "%s" runtime.', $class));
    }
    public function addExtension(\MailPoetVendor\Twig\Extension\ExtensionInterface $extension)
    {
    ...
    public function addTokenParser(\MailPoetVendor\Twig\TokenParser\TokenParserInterface $parser)
    {
        if ($this->extensionInitialized) {
    ...
    public function getTags()
    {
        ...
        foreach ($this->getTokenParsers()->getParsers() as $parser) {
            if ($parser instanceof \MailPoetVendor\Twig\TokenParser\TokenParserInterface) {
    ...
    {
        if (!$name instanceof \MailPoetVendor\Twig\TwigFilter && !($filter instanceof \MailPoetVendor\Twig\TwigFilter || $filter instanceof \MailPoetVendor\Twig_FilterInterface)) {
            throw new \LogicException('A filter must be an instance of \\Twig_FilterInterface or \\Twig_SimpleFilter.');
        }
        if ($name instanceof \MailPoetVendor\Twig\TwigFilter) {
            $filter = $name;
            $name = $filter->getName();
        } else {
    ...
    {
        if (!$name instanceof \MailPoetVendor\Twig\TwigTest && !($test instanceof \MailPoetVendor\Twig\TwigTest || $test instanceof \MailPoetVendor\Twig_TestInterface)) {
            throw new \LogicException('A test must be an instance of \\Twig_TestInterface or \\Twig_SimpleTest.');
        }
        if ($name instanceof \MailPoetVendor\Twig\TwigTest) {
            $test = $name;
            $name = $test->getName();
        } else {
    ...
    {
        if (!$name instanceof \MailPoetVendor\Twig\TwigFunction && !($function instanceof \MailPoetVendor\Twig\TwigFunction || $function instanceof \MailPoetVendor\Twig_FunctionInterface)) {
            throw new \LogicException('A function must be an instance of \\Twig_FunctionInterface or \\Twig_SimpleFunction.');
        }
        if ($name instanceof \MailPoetVendor\Twig\TwigFunction) {
            $function = $name;
    ...
    public function computeAlternatives($name, $items)
    {
        ...
        return \MailPoetVendor\Twig\Error\SyntaxError::computeAlternatives($name, $items);
    }
    /**
     * @internal
     */
    protected function initGlobals()
    {
        ...
        foreach ($this->extensions as $name => $extension) {
            if (!$extension instanceof \MailPoetVendor\Twig\Extension\GlobalsInterface) {
    ...
    protected function initExtensions()
    {
        ...
        $this->parsers = new \MailPoetVendor\Twig_TokenParserBroker([], [], \false);
        $this->filters = [];
        $this->functions = [];
        $this->tests = [];
        $this->visitors = [];
     ...
     * @internal
     */
    protected function initExtension(\MailPoetVendor\Twig\Extension\ExtensionInterface $extension)
    {
        // filters
        ...
        foreach ($extension->getTokenParsers() as $parser) {
            ...
            } elseif ($parser instanceof \MailPoetVendor\Twig_TokenParserBrokerInterface) {
    ...
    {
        $hashParts = \array_merge(\array_keys($this->extensions), [(int) \function_exists('MailPoetVendor\\twig_template_get_attributes'), \PHP_MAJOR_VERSION, \PHP_MINOR_VERSION, self::VERSION, (int) $this->debug, $this->baseTemplateClass, (int) $this->strictVariables]);
        $this->optionsHash = \implode(':', $hashParts);
    }
}
\class_alias('MailPoetVendor\\Twig\\Environment', 'MailPoetVendor\\Twig_Environment');
