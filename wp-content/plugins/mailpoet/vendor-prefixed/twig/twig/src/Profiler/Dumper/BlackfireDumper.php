...
EOF;
    ...
    private function dumpChildren($parent, \MailPoetVendor\Twig\Profiler\Profile $profile, &$data)
    {
    ...
    private function dumpProfile($edge, \MailPoetVendor\Twig\Profiler\Profile $profile, &$data)
    {
        if (isset($data[$edge])) {
            ++$data[$edge]['ct'];
