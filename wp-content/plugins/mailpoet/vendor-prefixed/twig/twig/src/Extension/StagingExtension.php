 ...
 * @internal
 */
class StagingExtension extends \MailPoetVendor\Twig\Extension\AbstractExtension
{
    protected $functions = [];
    protected $filters = [];
    protected $visitors = [];
...
\class_alias('MailPoetVendor\\Twig\\Extension\\StagingExtension', 'MailPoetVendor\\Twig_Extension_Staging');
