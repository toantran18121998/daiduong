 ...
 */
class Compiler implements \MailPoetVendor\Twig_CompilerInterface
{
    protected $lastLine;
    protected $source;
     ...
     * @return $this
     */
    public function compile(\MailPoetVendor\Twig_NodeInterface $node, $indentation = 0)
    {
        $this->lastLine = null;
        $this->source = '';
        $this->debugInfo = [];
    ...
    public function subcompile(\MailPoetVendor\Twig_NodeInterface $node, $raw = \true)
    {
        if (\false === $raw) {
     ...
     * @return $this
     */
    public function addDebugInfo(\MailPoetVendor\Twig_NodeInterface $node)
    {
