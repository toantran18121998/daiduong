    ...
    */
    ...
    public function __construct()
    {
        ...
        */
        ...
        // call load_template
        $this->optimise = new \MailPoetVendor\csstidy_optimise($this);
    ...
    public function parse($string)
    {
        ...
        $this->print = new \MailPoetVendor\csstidy_print($this);
        $this->optimise = new \MailPoetVendor\csstidy_optimise($this);
    ...
    {
        return !(@($string[$pos - 1] !== '\\') || \MailPoetVendor\csstidy::escaped($string, $pos - 1));
    }
    /**
