 ...
 */
class SocketHandler extends \MailPoetVendor\Monolog\Handler\AbstractProcessingHandler
{
     ...
     */
    public function __construct($connectionString, $level = \MailPoetVendor\Monolog\Logger::DEBUG, $bubble = \true)
    {
