...
use MailPoetVendor\Monolog\Formatter\WildfireFormatter;
/**
 * Simple FirePHP Handler (http://www.firephp.org/), which uses the Wildfire protocol.
 *
 * @author Eric Clemmons (@ericclemmons) <eric@uxdriven.com>
 */
class FirePHPHandler extends \MailPoetVendor\Monolog\Handler\AbstractProcessingHandler
{
    /**
    ...
    {
        return new \MailPoetVendor\Monolog\Formatter\WildfireFormatter();
    }
    /**
