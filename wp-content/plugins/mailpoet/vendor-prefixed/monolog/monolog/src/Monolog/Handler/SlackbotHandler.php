 ...
 */
class SlackbotHandler extends \MailPoetVendor\Monolog\Handler\AbstractProcessingHandler
{
    /**
     ...
     */
    public function __construct($slackTeam, $token, $channel, $level = \MailPoetVendor\Monolog\Logger::CRITICAL, $bubble = \true)
    {
