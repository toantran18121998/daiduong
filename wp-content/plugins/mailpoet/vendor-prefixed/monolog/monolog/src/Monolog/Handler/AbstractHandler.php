 ...
 */
abstract class AbstractHandler implements \MailPoetVendor\Monolog\Handler\HandlerInterface, \MailPoetVendor\Monolog\ResettableInterface
{
    protected $level = \MailPoetVendor\Monolog\Logger::DEBUG;
    ...
    {
        $this->level = \MailPoetVendor\Monolog\Logger::toMonologLevel($level);
        return $this;
    }
    /**
    ...
    {
        return new \MailPoetVendor\Monolog\Formatter\LineFormatter();
    }
}
