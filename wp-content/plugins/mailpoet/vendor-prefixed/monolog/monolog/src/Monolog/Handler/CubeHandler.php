 ...
 */
class CubeHandler extends \MailPoetVendor\Monolog\Handler\AbstractProcessingHandler
{
     ...
     */
    public function __construct($url, $level = \MailPoetVendor\Monolog\Logger::DEBUG, $bubble = \true)
    {
    ...
    protected function write(array $record)
    {
        ...
        if ($this->scheme === 'http') {
            $this->writeHttp(\MailPoetVendor\Monolog\Utils::jsonEncode($data));
        } else {
            $this->writeUdp(\MailPoetVendor\Monolog\Utils::jsonEncode($data));
        }
    }
    ...
    private function writeHttp($data)
    {
        ...
        \MailPoetVendor\Monolog\Handler\Curl\Util::execute($this->httpConnection, 5, \false);
    }
}
