 ...
 */
class PushoverHandler extends \MailPoetVendor\Monolog\Handler\SocketHandler
{
    private $token;
    private $users;
    private $title;
     ...
     */
    public function __construct($token, $users, $title = null, $level = \MailPoetVendor\Monolog\Logger::CRITICAL, $bubble = \true, $useSSL = \true, $highPriorityLevel = \MailPoetVendor\Monolog\Logger::CRITICAL, $emergencyLevel = \MailPoetVendor\Monolog\Logger::EMERGENCY, $retry = 30, $expire = 25200)
    {
        ...
        $this->highPriorityLevel = \MailPoetVendor\Monolog\Logger::toMonologLevel($highPriorityLevel);
        $this->emergencyLevel = \MailPoetVendor\Monolog\Logger::toMonologLevel($emergencyLevel);
        $this->retry = $retry;
        $this->expire = $expire;
    }
