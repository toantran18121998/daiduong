 ...
 */
class BrowserConsoleHandler extends \MailPoetVendor\Monolog\Handler\AbstractProcessingHandler
{
    ...
    {
        return new \MailPoetVendor\Monolog\Formatter\LineFormatter('[[%channel%]]{macro: autolabel} [[%level_name%]]{font-weight: bold} %message%');
    }
    /**
     * {@inheritDoc}
     */
