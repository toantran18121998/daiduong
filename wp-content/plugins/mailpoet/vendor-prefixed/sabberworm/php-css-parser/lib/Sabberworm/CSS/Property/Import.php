...
*/
class Import implements \MailPoetVendor\Sabberworm\CSS\Property\AtRule
{
    private $oLocation;
    private $sMediaQuery;
    protected $iLineNo;
    protected $aComments;
    public function __construct(\MailPoetVendor\Sabberworm\CSS\Value\URL $oLocation, $sMediaQuery, $iLineNo = 0)
    {
