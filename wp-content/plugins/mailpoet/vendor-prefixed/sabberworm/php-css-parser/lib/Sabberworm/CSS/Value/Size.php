...
class Size extends \MailPoetVendor\Sabberworm\CSS\Value\PrimitiveValue
{
    ...
    public static function parse(\MailPoetVendor\Sabberworm\CSS\Parsing\ParserState $oParserState, $bIsColorComponent = \false)
    {
        $sSize = '';
        ...
        return new \MailPoetVendor\Sabberworm\CSS\Value\Size(\floatval($sSize), $sUnit, $bIsColorComponent, $oParserState->currentLine());
    }
