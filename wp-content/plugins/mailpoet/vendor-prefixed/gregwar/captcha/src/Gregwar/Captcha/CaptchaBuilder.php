 ...
 */
class CaptchaBuilder implements \MailPoetVendor\Gregwar\Captcha\CaptchaBuilderInterface
{
    /**
     * @var array
     */
     ...
     */
    public $tempDir = 'temp/';
    public function __construct($phrase = null, \MailPoetVendor\Gregwar\Captcha\PhraseBuilderInterface $builder = null)
    {
        if ($builder === null) {
            $this->builder = new \MailPoetVendor\Gregwar\Captcha\PhraseBuilder();
        } else {
