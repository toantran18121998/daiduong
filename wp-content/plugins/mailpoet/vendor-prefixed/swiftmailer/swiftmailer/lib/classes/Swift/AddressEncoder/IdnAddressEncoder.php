 ...
 */
class Swift_AddressEncoder_IdnAddressEncoder implements \MailPoetVendor\Swift_AddressEncoder
{
    /**
    ...
    public function encodeString(string $address) : string
    {
        ...
        if (\false !== $i) {
            ...
            if (\preg_match('/[^\\x00-\\x7F]/', $local)) {
                throw new \MailPoetVendor\Swift_AddressEncoderException('Non-ASCII characters not supported in local-part', $address);
            }
