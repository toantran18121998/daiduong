 ...
 * @author Chris Corbyn
 */
class Swift_Plugins_AntiFloodPlugin implements \MailPoetVendor\Swift_Events_SendListener, \MailPoetVendor\Swift_Plugins_Sleeper
{
    /**
     ...
     */
    public function __construct($threshold = 99, $sleep = 0, \MailPoetVendor\Swift_Plugins_Sleeper $sleeper = null)
    {
