 ...
 * @author     Chris Corbyn
 */
abstract class Swift_Mime_Headers_AbstractHeader implements \MailPoetVendor\Swift_Mime_Header
{
     ...
     */
    public function setEncoder(\MailPoetVendor\Swift_Mime_HeaderEncoder $encoder)
    {
     ...
     * @return string
     */
    protected function createPhrase(\MailPoetVendor\Swift_Mime_Header $header, $string, $charset, \MailPoetVendor\Swift_Mime_HeaderEncoder $encoder = null, $shorten = \false)
    {
     ...
     * @return string
     */
    protected function encodeWords(\MailPoetVendor\Swift_Mime_Header $header, $input, $usedLength = -1)
    {
        $value = '';
