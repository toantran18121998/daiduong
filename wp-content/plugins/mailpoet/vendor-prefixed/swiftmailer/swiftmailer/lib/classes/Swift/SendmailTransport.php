...
class Swift_SendmailTransport extends \MailPoetVendor\Swift_Transport_SendmailTransport
{
    ...
    {
        \call_user_func_array([$this, 'MailPoetVendor\\Swift_Transport_SendmailTransport::__construct'], \MailPoetVendor\Swift_DependencyContainer::getInstance()->createDependenciesFor('transport.sendmail'));
