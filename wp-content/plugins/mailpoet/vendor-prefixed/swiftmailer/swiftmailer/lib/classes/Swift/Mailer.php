...
class Swift_Mailer
{
     ...
     */
    public function __construct(\MailPoetVendor\Swift_Transport $transport)
    {
    ...
    {
        return \MailPoetVendor\Swift_DependencyContainer::getInstance()->lookup('message.' . $service);
    }
    /**
    ...
    public function send(\MailPoetVendor\Swift_Mime_SimpleMessage $message, &$failedRecipients = null)
    {
        ...
        } catch (\MailPoetVendor\Swift_RfcComplianceException $e) {
