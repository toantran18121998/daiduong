 ...
 */
class Swift_CharacterStream_NgCharacterStream implements \MailPoetVendor\Swift_CharacterStream
{
    /**
     ...
     */
    public function __construct(\MailPoetVendor\Swift_CharacterReaderFactory $factory, $charset)
    {
     ...
     */
    public function setCharacterReaderFactory(\MailPoetVendor\Swift_CharacterReaderFactory $factory)
    {
     ...
     */
    public function importByteStream(\MailPoetVendor\Swift_OutputByteStream $os)
    {
        $this->flushContents();
        $blocks = 512;
        $os->setReadPointer(0);
    ...
    public function read($length)
    {
        ...
        switch ($this->mapType) {
            case \MailPoetVendor\Swift_CharacterReader::MAP_TYPE_FIXED_LEN:
                $len = $length * $this->map;
                $ret = \substr($this->datas, $this->currentPos * $this->map, $len);
                $this->currentPos += $length;
                break;
            case \MailPoetVendor\Swift_CharacterReader::MAP_TYPE_INVALID:
                $ret = '';
                ...
                break;
            case \MailPoetVendor\Swift_CharacterReader::MAP_TYPE_POSITIONS:
