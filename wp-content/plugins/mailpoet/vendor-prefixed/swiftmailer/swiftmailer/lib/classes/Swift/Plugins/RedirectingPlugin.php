 ...
 */
class Swift_Plugins_RedirectingPlugin implements \MailPoetVendor\Swift_Events_SendListener
{
    /**
     ...
     * @param string $type
     */
    private function filterHeaderSet(\MailPoetVendor\Swift_Mime_SimpleHeaderSet $headerSet, $type)
    {
