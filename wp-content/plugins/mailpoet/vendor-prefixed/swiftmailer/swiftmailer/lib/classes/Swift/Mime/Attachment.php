 ...
 * @author Chris Corbyn
 */
class Swift_Mime_Attachment extends \MailPoetVendor\Swift_Mime_SimpleMimeEntity
{
     ...
     */
    public function __construct(\MailPoetVendor\Swift_Mime_SimpleHeaderSet $headers, \MailPoetVendor\Swift_Mime_ContentEncoder $encoder, \MailPoetVendor\Swift_KeyCache $cache, \MailPoetVendor\Swift_IdGenerator $idGenerator, $mimeTypes = [])
    {
     ...
     * @return $this
     */
    public function setFile(\MailPoetVendor\Swift_FileStream $file, $contentType = null)
    {
