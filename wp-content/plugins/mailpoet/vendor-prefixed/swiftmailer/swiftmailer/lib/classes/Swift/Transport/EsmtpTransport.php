 ...
 * @author Chris Corbyn
 */
class Swift_Transport_EsmtpTransport extends \MailPoetVendor\Swift_Transport_AbstractSmtpTransport implements \MailPoetVendor\Swift_Transport_SmtpAgent
{
    /**
     ...
     * @var array
     */
    private $params = ['protocol' => 'tcp', 'host' => 'localhost', 'port' => 25, 'timeout' => 30, 'blocking' => 1, 'tls' => \false, 'type' => \MailPoetVendor\Swift_Transport_IoBuffer::TYPE_SOCKET, 'stream_context_options' => []];
    /**
     ...
     */
    public function __construct(\MailPoetVendor\Swift_Transport_IoBuffer $buf, array $extensionHandlers, \MailPoetVendor\Swift_Events_EventDispatcher $dispatcher, $localDomain = '127.0.0.1', \MailPoetVendor\Swift_AddressEncoder $addressEncoder = null)
    {
        ...
        if ($this->params['tls']) {
            try {
                ...
                if (!$this->buffer->startTLS()) {
                    throw new \MailPoetVendor\Swift_TransportException('Unable to connect with TLS encryption');
                }
                try {
                    $response = $this->executeCommand(\sprintf("EHLO %s\r\n", $this->domain), [250]);
                } catch (\MailPoetVendor\Swift_TransportException $e) {
