 ...
 */
class Swift_Transport_Esmtp_Auth_XOAuth2Authenticator implements \MailPoetVendor\Swift_Transport_Esmtp_Authenticator
{
    /**
     ...
     * {@inheritdoc}
     */
    public function authenticate(\MailPoetVendor\Swift_Transport_SmtpAgent $agent, $email, $token)
    {
        try {
