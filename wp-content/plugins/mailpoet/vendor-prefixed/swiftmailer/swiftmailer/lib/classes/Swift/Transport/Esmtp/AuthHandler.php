 ...
 * @author Chris Corbyn
 */
class Swift_Transport_Esmtp_AuthHandler implements \MailPoetVendor\Swift_Transport_EsmtpHandler
{
    /**
     ...
     */
    public function afterEhlo(\MailPoetVendor\Swift_Transport_SmtpAgent $agent)
    {
        if ($this->username) {
            $count = 0;
            $errors = [];
            ...
            throw new \MailPoetVendor\Swift_TransportException($message);
        }
    }
    /**
     * Not used.
     ...
     * Not used.
     */
    public function onCommand(\MailPoetVendor\Swift_Transport_SmtpAgent $agent, $command, $codes = [], &$failedRecipients = null, &$stop = \false)
    {
    }
    /**
    ...
    protected function getAuthenticatorsForAgent()
    {
        ...
        throw new \MailPoetVendor\Swift_TransportException('Auth mode ' . $mode . ' is invalid');
    }
}
