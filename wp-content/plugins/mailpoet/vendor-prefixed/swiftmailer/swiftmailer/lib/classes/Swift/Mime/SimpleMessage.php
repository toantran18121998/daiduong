 ...
 * @author Chris Corbyn
 */
class Swift_Mime_SimpleMessage extends \MailPoetVendor\Swift_Mime_MimePart
{
     ...
     */
    public function __construct(\MailPoetVendor\Swift_Mime_SimpleHeaderSet $headers, \MailPoetVendor\Swift_Mime_ContentEncoder $encoder, \MailPoetVendor\Swift_KeyCache $cache, \MailPoetVendor\Swift_IdGenerator $idGenerator, $charset = null)
    {
     ...
     * @return $this
     */
    public function attach(\MailPoetVendor\Swift_Mime_SimpleMimeEntity $entity)
    {
     ...
     * @return $this
     */
    public function detach(\MailPoetVendor\Swift_Mime_SimpleMimeEntity $entity)
    {
        $newChildren = [];
     ...
     * @return string
     */
    public function embed(\MailPoetVendor\Swift_Mime_SimpleMimeEntity $entity)
    {
        $this->attach($entity);
