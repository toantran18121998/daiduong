 ...
 */
class Swift_Transport_NullTransport implements \MailPoetVendor\Swift_Transport
{
     ...
     * Constructor.
     */
    public function __construct(\MailPoetVendor\Swift_Events_EventDispatcher $eventDispatcher)
    {
