 ...
 */
class Swift_Plugins_DecoratorPlugin implements \MailPoetVendor\Swift_Events_SendListener, \MailPoetVendor\Swift_Plugins_Decorator_Replacements
{
    /** The replacement map */
    ...
    {
        if (!$replacements instanceof \MailPoetVendor\Swift_Plugins_Decorator_Replacements) {
    ...
    {
        if ($this->replacements instanceof \MailPoetVendor\Swift_Plugins_Decorator_Replacements) {
    ...
    private function restoreMessage(\MailPoetVendor\Swift_Mime_SimpleMessage $message)
    {
