 ...
 */
class Swift_Mime_ContentEncoder_QpContentEncoderProxy implements \MailPoetVendor\Swift_Mime_ContentEncoder
{
    /**
     ...
     */
    public function __construct(\MailPoetVendor\Swift_Mime_ContentEncoder_QpContentEncoder $safeEncoder, \MailPoetVendor\Swift_Mime_ContentEncoder_NativeQpContentEncoder $nativeEncoder, $charset)
    {
     ...
     * {@inheritdoc}
     */
    public function encodeByteStream(\MailPoetVendor\Swift_OutputByteStream $os, \MailPoetVendor\Swift_InputByteStream $is, $firstLineOffset = 0, $maxLineLength = 0)
    {
