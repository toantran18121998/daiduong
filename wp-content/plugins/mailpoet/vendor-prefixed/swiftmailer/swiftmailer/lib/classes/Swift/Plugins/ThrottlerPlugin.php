 ...
 * @author Chris Corbyn
 */
class Swift_Plugins_ThrottlerPlugin extends \MailPoetVendor\Swift_Plugins_BandwidthMonitorPlugin implements \MailPoetVendor\Swift_Plugins_Sleeper, \MailPoetVendor\Swift_Plugins_Timer
{
     ...
     */
    public function __construct($rate, $mode = self::BYTES_PER_MINUTE, \MailPoetVendor\Swift_Plugins_Sleeper $sleeper = null, \MailPoetVendor\Swift_Plugins_Timer $timer = null)
    {
        $this->rate = $rate;
        $this->mode = $mode;
