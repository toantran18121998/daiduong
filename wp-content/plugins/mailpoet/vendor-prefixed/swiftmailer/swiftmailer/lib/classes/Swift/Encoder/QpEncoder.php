 ...
 * @author     Chris Corbyn
 */
class Swift_Encoder_QpEncoder implements \MailPoetVendor\Swift_Encoder
{
    /**
     ...
     */
    public function __construct(\MailPoetVendor\Swift_CharacterStream $charStream, \MailPoetVendor\Swift_StreamFilter $filter = null)
    {
