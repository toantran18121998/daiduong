 ...
 * @author Chris Corbyn
 */
class Swift_Mime_SimpleHeaderSet implements \MailPoetVendor\Swift_Mime_CharsetObserver
{
    /** HeaderFactory */
    private $factory;
     ...
     */
    public function __construct(\MailPoetVendor\Swift_Mime_SimpleHeaderFactory $factory, $charset = null)
    {
     ...
     * @param int $index
     */
    public function set(\MailPoetVendor\Swift_Mime_Header $header, $index = 0)
    {
    ...
    private function storeHeader($name, \MailPoetVendor\Swift_Mime_Header $header, $offset = null)
    {
    ...
    private function isDisplayed(\MailPoetVendor\Swift_Mime_Header $header)
    {
