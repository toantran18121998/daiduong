 ...
 * @author Chris Corbyn
 */
class Swift_Transport_LoadBalancedTransport implements \MailPoetVendor\Swift_Transport
{
    /**
    ...
    public function send(\MailPoetVendor\Swift_Mime_SimpleMessage $message, &$failedRecipients = null)
    {
        ...
        if (0 == \count($this->transports)) {
            throw new \MailPoetVendor\Swift_TransportException('All Transports in LoadBalancedTransport failed, or no Transports available');
        }
        return $sent;
    }
    /**
