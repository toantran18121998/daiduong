 ...
 * @author Chris Corbyn
 */
class Swift_CharacterReaderFactory_SimpleCharacterReaderFactory implements \MailPoetVendor\Swift_CharacterReaderFactory
{
    /**
    ...
    public function init()
    {
        ...
        // Utf-8
        self::$map['utf-?8'] = ['class' => $prefix . 'Utf8Reader', 'constructor' => []];
        //7-8 bit charsets
