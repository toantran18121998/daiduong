 ...
 * @author     Chris Corbyn
 */
class Swift_Mime_ContentEncoder_QpContentEncoder extends \MailPoetVendor\Swift_Encoder_QpEncoder implements \MailPoetVendor\Swift_Mime_ContentEncoder
{
    protected $dotEscape;
    /**
     ...
     */
    public function __construct(\MailPoetVendor\Swift_CharacterStream $charStream, \MailPoetVendor\Swift_StreamFilter $filter = null, $dotEscape = \false)
    {
