...
class CarbonInterval extends \DateInterval
{
    ...
    {
        return static::getFactor('dayz', 'weeks') ?: \MailPoetVendor\Carbon\Carbon::DAYS_PER_WEEK;
    }
    /**
    ...
    {
        return static::getFactor('hours', 'dayz') ?: \MailPoetVendor\Carbon\Carbon::HOURS_PER_DAY;
    }
    /**
    ...
    {
        return static::getFactor('minutes', 'hours') ?: \MailPoetVendor\Carbon\Carbon::MINUTES_PER_HOUR;
    }
    /**
    ...
    {
        return static::getFactor('seconds', 'minutes') ?: \MailPoetVendor\Carbon\Carbon::SECONDS_PER_MINUTE;
    }
    /**
     ...
     * @return static
     */
    public static function instance(\DateInterval $di, $trimMicroseconds = \true)
    {
    ...
    {
        return \MailPoetVendor\Carbon\CarbonPeriod::createFromArray(\array_merge(array($this), \func_get_args()));
    }
    /**
     * Invert the interval.
     *
    ...
    {
        $current = \MailPoetVendor\Carbon\Carbon::now();
