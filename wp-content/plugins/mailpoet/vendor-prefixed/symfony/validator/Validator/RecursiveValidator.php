 ...
 */
class RecursiveValidator implements \MailPoetVendor\Symfony\Component\Validator\Validator\ValidatorInterface
{
    ...
    {
        return new \MailPoetVendor\Symfony\Component\Validator\Validator\RecursiveContextualValidator($this->contextFactory->createContext($this, $root), $this->metadataFactory, $this->validatorFactory, $this->objectInitializers);
    }
    /**
     * {@inheritdoc}
     */
    ...
    {
        return new \MailPoetVendor\Symfony\Component\Validator\Validator\RecursiveContextualValidator($context, $this->metadataFactory, $this->validatorFactory, $this->objectInitializers);
    }
    /**
     * {@inheritdoc}
     */
