 ...
 */
class Ip extends \MailPoetVendor\Symfony\Component\Validator\Constraint
{
    const V4 = '4';
    const V6 = '6';
    const ALL = 'all';
    ...
    public function __construct($options = null)
    {
        ...
        if (!\in_array($this->version, self::$versions)) {
            throw new \MailPoetVendor\Symfony\Component\Validator\Exception\ConstraintDefinitionException(\sprintf('The option "version" must be one of "%s"', \implode('", "', self::$versions)));
        }
    }
}
