 ...
 */
class File extends \MailPoetVendor\Symfony\Component\Validator\Constraint
{
    ...
    private function normalizeBinaryFormat($maxSize)
    {
        ...
        if (\ctype_digit((string) $maxSize)) {
            ...
            throw new \MailPoetVendor\Symfony\Component\Validator\Exception\ConstraintDefinitionException(\sprintf('"%s" is not a valid maximum size', $this->maxSize));
        }
    }
}
