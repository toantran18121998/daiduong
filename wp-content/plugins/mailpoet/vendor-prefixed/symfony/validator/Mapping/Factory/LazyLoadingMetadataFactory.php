 ...
 */
class LazyLoadingMetadataFactory implements \MailPoetVendor\Symfony\Component\Validator\Mapping\Factory\MetadataFactoryInterface
{
    protected $loader;
    protected $cache;
    /**
     ...
     *                                     between multiple PHP requests
     */
    public function __construct(\MailPoetVendor\Symfony\Component\Validator\Mapping\Loader\LoaderInterface $loader = null, \MailPoetVendor\Symfony\Component\Validator\Mapping\Cache\CacheInterface $cache = null)
    {
        $this->loader = $loader;
        $this->cache = $cache;
    }
    ...
    public function getMetadataFor($value)
    {
        if (!\is_object($value) && !\is_string($value)) {
            throw new \MailPoetVendor\Symfony\Component\Validator\Exception\NoSuchMetadataException(\sprintf('Cannot create metadata for non-objects. Got: %s', \gettype($value)));
        }
        ...
        if (!\class_exists($class) && !\interface_exists($class, \false)) {
            throw new \MailPoetVendor\Symfony\Component\Validator\Exception\NoSuchMetadataException(\sprintf('The class or interface "%s" does not exist.', $class));
        }
        ...
        $metadata = new \MailPoetVendor\Symfony\Component\Validator\Mapping\ClassMetadata($class);
        if (null !== $this->loader) {
    ...
    private function mergeConstraints(\MailPoetVendor\Symfony\Component\Validator\Mapping\ClassMetadata $metadata)
    {
        // Include constraints from the parent class
