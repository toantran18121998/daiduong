 ...
 */
class YamlFileLoader extends \MailPoetVendor\Symfony\Component\Validator\Mapping\Loader\FileLoader
{
    /**
    ...
    private function parseFile($path)
    {
        ...
        try {
            $classes = $this->yamlParser->parseFile($path, \MailPoetVendor\Symfony\Component\Yaml\Yaml::PARSE_CONSTANT);
    ...
    private function loadClassMetadataFromYaml(\MailPoetVendor\Symfony\Component\Validator\Mapping\ClassMetadata $metadata, array $classDescription)
    {
