 ...
 */
abstract class MemberMetadata extends \MailPoetVendor\Symfony\Component\Validator\Mapping\GenericMetadata implements \MailPoetVendor\Symfony\Component\Validator\Mapping\PropertyMetadataInterface
{
    /**
    ...
    {
        if (!\in_array(\MailPoetVendor\Symfony\Component\Validator\Constraint::PROPERTY_CONSTRAINT, (array) $constraint->getTargets())) {
            throw new \MailPoetVendor\Symfony\Component\Validator\Exception\ConstraintDefinitionException(\sprintf('The constraint %s cannot be put on properties or getters', \get_class($constraint)));
        }
