...
class RecursiveDirectoryIterator extends \RecursiveDirectoryIterator
{
    ...
    public function current()
    {
        ...
        return new \MailPoetVendor\Symfony\Component\Finder\SplFileInfo($this->rootPath . $this->directorySeparator . $subPathname, $this->subPath, $subPathname);
    }
    /**
    ...
    public function getChildren()
    {
        try {
            ...
            if ($this->ignoreUnreadableDirs) {
                ...
                throw new \MailPoetVendor\Symfony\Component\Finder\Exception\AccessDeniedException($e->getMessage(), $e->getCode(), $e);
            }
        }
    }
    /**
