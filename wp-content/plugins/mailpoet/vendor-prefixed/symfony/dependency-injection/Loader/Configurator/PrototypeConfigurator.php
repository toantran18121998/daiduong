 ...
 */
class PrototypeConfigurator extends \MailPoetVendor\Symfony\Component\DependencyInjection\Loader\Configurator\AbstractServiceConfigurator
{
    const FACTORY = 'load';
    ...
    private $exclude;
    private $allowParent;
    public function __construct(\MailPoetVendor\Symfony\Component\DependencyInjection\Loader\Configurator\ServicesConfigurator $parent, \MailPoetVendor\Symfony\Component\DependencyInjection\Loader\PhpFileLoader $loader, \MailPoetVendor\Symfony\Component\DependencyInjection\Definition $defaults, $namespace, $resource, $allowParent)
    {
