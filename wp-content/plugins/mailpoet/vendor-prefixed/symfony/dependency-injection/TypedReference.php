 ...
 */
class TypedReference extends \MailPoetVendor\Symfony\Component\DependencyInjection\Reference
{
    private $type;
     ...
     */
    public function __construct($id, $type, $requiringClass = '', $invalidBehavior = \MailPoetVendor\Symfony\Component\DependencyInjection\ContainerInterface::EXCEPTION_ON_INVALID_REFERENCE)
    {
