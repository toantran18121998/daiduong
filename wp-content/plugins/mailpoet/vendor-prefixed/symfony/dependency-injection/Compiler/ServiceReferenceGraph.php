...
class ServiceReferenceGraph
{
    ...
    public function getNode($id)
    {
        if (!isset($this->nodes[$id])) {
            throw new \MailPoetVendor\Symfony\Component\DependencyInjection\Exception\InvalidArgumentException(\sprintf('There is no node with id "%s".', $id));
        }
    ...
    private function createNode($id, $value)
    {
        ...
        return $this->nodes[$id] = new \MailPoetVendor\Symfony\Component\DependencyInjection\Compiler\ServiceReferenceGraphNode($id, $value);
    }
}
