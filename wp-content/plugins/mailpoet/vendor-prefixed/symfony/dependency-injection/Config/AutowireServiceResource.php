...
use MailPoetVendor\Symfony\Component\Config\Resource\SelfCheckingResourceInterface;
use MailPoetVendor\Symfony\Component\DependencyInjection\Compiler\AutowirePass;
/**
 * @deprecated since version 3.3, to be removed in 4.0. Use ContainerBuilder::getReflectionClass() instead.
 */
class AutowireServiceResource implements \MailPoetVendor\Symfony\Component\Config\Resource\SelfCheckingResourceInterface, \Serializable
{
    private $class;
    private $filePath;
    ...
    public function isFresh($timestamp)
    {
        ...
        return (array) $this === (array) \MailPoetVendor\Symfony\Component\DependencyInjection\Compiler\AutowirePass::createResourceForClass($reflectionClass);
    }
