 ...
 */
class GraphvizDumper extends \MailPoetVendor\Symfony\Component\DependencyInjection\Dumper\Dumper
{
    private $nodes;
    private $edges;
    ...
    {
        $parameterBag = new \MailPoetVendor\Symfony\Component\DependencyInjection\ParameterBag\ParameterBag($this->container->getParameterBag()->all());
        $container = new \MailPoetVendor\Symfony\Component\DependencyInjection\ContainerBuilder($parameterBag);
