 ...
 */
class ServiceNotFoundException extends \MailPoetVendor\Symfony\Component\DependencyInjection\Exception\InvalidArgumentException implements \MailPoetVendor\Psr\Container\NotFoundExceptionInterface
{
    private $id;
    private $sourceId;
