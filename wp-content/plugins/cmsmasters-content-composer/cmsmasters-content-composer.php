...
class Cmsmasters_Content_Composer { 
	function __construct() { 
		define('CMSMASTERS_CONTENT_COMPOSER_VERSION', '1.7.4');
		...
		if (
			...
			($pagenow == 'post-new.php' && isset($_GET['post_type']) && !in_array($_GET['post_type'], $gutenberg_skip_posttype)) || 
			($pagenow == 'post.php' && isset($_GET['post']) && !in_array(get_post_type($_GET['post']), $gutenberg_skip_posttype)) 
		) {
